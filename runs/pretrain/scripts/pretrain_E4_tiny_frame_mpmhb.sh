#!/bin/bash
#SBATCH --job-name=E4_tiny_frame_mpmhb
...
TAG="E4_${dataset}_${task}_${model_size}_F${fshape}_T${tshape}_mask${mask_patch}_K${num_clusters}_mhb${mpmhb_weight}_mpc${mpc_weight}_mpg${mpg_weight}_layer${target_layer_idx}"
