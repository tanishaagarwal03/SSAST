#!/bin/bash
#SBATCH --job-name=E1_tiny_patch_joint_100
...
json_train="$SCRATCH/librispeech/librispeech_tr100_cut.json"
...
# "patch tokens" in your repo: 128 x 2
fshape=128
tshape=2
fstride=$fshape
tstride=$tshape

# mask count (see explanation below)
mask_patch=400
...
TAG="E1_100_${dataset}_${task}_${model_size}_F${fshape}_T${tshape}_mask${mask_patch}_e${epoch}_lr${lr}"
